...
@section('content')
    @include('partials.page-title', ['pageTitle' => 'Allgemeine Geschäftsbedingungen'])
    <section class="flat-spacing-9">
        <div class="container" style="max-width:820px;">
            ...
            <h5>11. Kontakt</h5>
            <p>Für Fragen zu diesen AGB erreichen Sie uns über unsere <a href="{{ route('pages.contact') }}">Kontaktseite</a> oder per E-Mail an <a href="mailto:info@heri-brennholz.ch">info@heri-brennholz.ch</a>.</p>
        </div>
    </section>
@endsection
